...
class GalleryActivity : AppCompatActivity(R.layout.activity_gallery) {
    ...
    private fun loadMonuments() {
        lifecycleScope.launch {
            val apiMonuments = SupabaseApi.fetchMonuments(this@GalleryActivity)
            val defaultMonuments = listOf(
                Monument(
                    1,
                    "Manatí",
            ...
            findViewById<RecyclerView>(R.id.recyclerView).adapter = MonumentAdapter(allMonuments) { monument ->
