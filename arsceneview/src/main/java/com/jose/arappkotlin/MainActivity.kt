...
class MainActivity : AppCompatActivity() {
    ...
    override fun onResume() {
        super.onResume()
        // checkAndRequestArCore() // Commented out as SceneView might handle ARCore setup internally
    ...
    private fun checkAndRequestArCore() {
        try {
            ...
            Log.e("MainActivity", "Ocurrió un error inesperado con ARCore.", Toast.LENGTH_LONG).show()
